...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePatientPost.mc?method=editCoteriePatientPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,likeCount,forwardCount,postUserId,channelType,createTime,optTime,remark,char1=',
				del:'CoteriePatientPost.mc?method=deleteCoteriePatientPost&PK=',
				view:'CoteriePatientPost.mc?method=detailCoteriePatientPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,likeCount,forwardCount,postUserId,channelType,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePatientPost.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,likeCount,forwardCount,postUserId,channelType,createTime,optTime,remark,char1'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<th align="center" rowName="postChannelType" orderName="post_channel_type:DESC" title=' 1 ȫƽ̨ͨ�� 2 ľ��ҽ���� 3 ľ�޽������� 4.��У����app ���� 5.��Уh5 ����  6Ȧ���� Ĭ��Ϊ6 ֻ����Ӫƽ̨���ܷ�1-5 '> 1 ȫƽ̨ͨ�� 2 ľ��ҽ���� 3 ľ�޽������� 4.��У����app ���� 5.��Уh5 ����  6Ȧ���� Ĭ��Ϊ6 ֻ����Ӫƽ̨���ܷ�1-5 </th>
								<!-- ������  Ȧ��id-->   
								...
								<!-- ������  ������-->   
								<th align="center" rowName="likeCount" orderName="like_count:DESC" title='������'>������</th>
								<!-- ������  ת����-->   
								<th align="center" rowName="forwardCount" orderName="forward_count:DESC" title='ת����'>ת����</th>
								<!-- ������  ������-->   
