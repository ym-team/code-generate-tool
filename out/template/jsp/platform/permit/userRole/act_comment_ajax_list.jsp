...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'ActComment.mc?method=editActComment&id,commentDesc,picUrl,commentStatus,memberId,actId,createTime,optTime,remark,char1=',
				del:'ActComment.mc?method=deleteActComment&PK=',
				view:'ActComment.mc?method=detailActComment&id,commentDesc,picUrl,commentStatus,memberId,actId,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'ActComment.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,commentDesc,picUrl,commentStatus,memberId,actId,createTime,optTime,remark,char1'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- 主键列  评论内容-->   
								<th align="center" rowName="commentDesc" orderName="comment_desc:DESC" title='评论内容'>评论内容</th>
								<!-- 主键列  帖子回复图片-->   
								<th align="center" rowName="picUrl" orderName="pic_url:DESC" title='帖子回复图片'>帖子回复图片</th>
								<!-- 主键列  回复状态 1 审核中 2 通过  3 不通过 默认为2-->   
								<th align="center" rowName="commentStatus" orderName="comment_status:DESC" title='回复状态 1 审核中 2 通过  3 不通过 默认为2'>回复状态 1 审核中 2 通过  3 不通过 默认为2</th>
								<!-- 主键列  评论用户id-->   
								<th align="center" rowName="memberId" orderName="member_id:DESC" title='评论用户id'>评论用户id</th>
								<!-- 主键列  活动id-->   
