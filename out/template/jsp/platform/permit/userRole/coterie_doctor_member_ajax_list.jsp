...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoterieDoctorMember.mc?method=editCoterieDoctorMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1=',
				del:'CoterieDoctorMember.mc?method=deleteCoterieDoctorMember&PK=',
				view:'CoterieDoctorMember.mc?method=detailCoterieDoctorMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoterieDoctorMember.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ-->   
								<th align="center" rowName="memberStatus" orderName="member_status:DESC" title='1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ'>1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ</th>
								<!-- ������  1.����Ա  2.��Ա-->   
