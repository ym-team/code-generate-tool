...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoterieDoctorPost.mc?method=editCoterieDoctorPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,postUserId,createTime,optTime,remark,char1=',
				del:'CoterieDoctorPost.mc?method=deleteCoterieDoctorPost&PK=',
				view:'CoterieDoctorPost.mc?method=detailCoterieDoctorPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,postUserId,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoterieDoctorPost.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,postUserId,createTime,optTime,remark,char1'
			};
