...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteUserAppAdviceDoctor(PK) {
			jQuery.ajax({
				url : "UserAppAdviceDoctor.mc?method=deleteUserAppAdviceDoctor",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/UserAppAdviceDoctor.mc?method=getAllPageUserAppAdviceDoctor" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/user_app_advice_doctor_edit.jsp'">���</button>
						</td>
						<td align="right">
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							UserAppAdviceDoctor view = new UserAppAdviceDoctor();
								for (int i = 0; i < list.size(); i++) {
									view = (UserAppAdviceDoctor) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="UserAppAdviceDoctor.mc?method=editUserAppAdviceDoctor&id,adviceTitle,adviceId,diseaseId,adviceType,patientId,doctorId,comboId,moeney,adviceStatus,chnanelType,payChannelType,isOpen,createTime,optTime,expireTime,remark,char1,char2=<%= view.getId() +":"+  view.getAdviceTitle() +":"+  view.getAdviceId() +":"+  view.getDiseaseId() +":"+  view.getAdviceType() +":"+  view.getPatientId() +":"+  view.getDoctorId() +":"+  view.getComboId() +":"+  view.getMoeney() +":"+  view.getAdviceStatus() +":"+  view.getChnanelType() +":"+  view.getPayChannelType() +":"+  view.getIsOpen() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getExpireTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getChar2() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteUserAppAdviceDoctor('<%= view.getId() +":"+  view.getAdviceTitle() +":"+  view.getAdviceId() +":"+  view.getDiseaseId() +":"+  view.getAdviceType() +":"+  view.getPatientId() +":"+  view.getDoctorId() +":"+  view.getComboId() +":"+  view.getMoeney() +":"+  view.getAdviceStatus() +":"+  view.getChnanelType() +":"+  view.getPayChannelType() +":"+  view.getIsOpen() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getExpireTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getChar2() %>')" title="ɾ��"></a>
											    <a class="o-view" href="UserAppAdviceDoctor.mc?method=detailUserAppAdviceDoctor&id,adviceTitle,adviceId,diseaseId,adviceType,patientId,doctorId,comboId,moeney,adviceStatus,chnanelType,payChannelType,isOpen,createTime,optTime,expireTime,remark,char1,char2=<%= view.getId() +":"+  view.getAdviceTitle() +":"+  view.getAdviceId() +":"+  view.getDiseaseId() +":"+  view.getAdviceType() +":"+  view.getPatientId() +":"+  view.getDoctorId() +":"+  view.getComboId() +":"+  view.getMoeney() +":"+  view.getAdviceStatus() +":"+  view.getChnanelType() +":"+  view.getPayChannelType() +":"+  view.getIsOpen() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getExpireTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getChar2() %>" title="����"></a> 
