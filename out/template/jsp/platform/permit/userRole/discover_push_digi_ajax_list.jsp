...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'DiscoverPushDigi.mc?method=editDiscoverPushDigi&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType=',
				del:'DiscoverPushDigi.mc?method=deleteDiscoverPushDigi&PK=',
				view:'DiscoverPushDigi.mc?method=detailDiscoverPushDigi&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType='
			};
			var options = {
				tableId:'pageTable',
				url:'DiscoverPushDigi.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
