...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'UserAppAdviceDoctor.mc?method=editUserAppAdviceDoctor&id,adviceTitle,adviceId,diseaseId,adviceType,patientId,doctorId,comboId,moeney,adviceStatus,chnanelType,payChannelType,isOpen,createTime,optTime,expireTime,remark,char1,char2=',
				del:'UserAppAdviceDoctor.mc?method=deleteUserAppAdviceDoctor&PK=',
				view:'UserAppAdviceDoctor.mc?method=detailUserAppAdviceDoctor&id,adviceTitle,adviceId,diseaseId,adviceType,patientId,doctorId,comboId,moeney,adviceStatus,chnanelType,payChannelType,isOpen,createTime,optTime,expireTime,remark,char1,char2='
			};
			var options = {
				tableId:'pageTable',
				url:'UserAppAdviceDoctor.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,adviceTitle,adviceId,diseaseId,adviceType,patientId,doctorId,comboId,moeney,adviceStatus,chnanelType,payChannelType,isOpen,createTime,optTime,expireTime,remark,char1,char2'
			};
