...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'AcctChannelPayoutProcess.mc?method=editAcctChannelPayoutProcess&pkId,batchNo,busiType,fromAccountId,toAccountId,fromChannelAccountId,toChannelAccountId,channelType,payFee,payStatus,createDate,opTime,status,remark=',
				del:'AcctChannelPayoutProcess.mc?method=deleteAcctChannelPayoutProcess&PK=',
				view:'AcctChannelPayoutProcess.mc?method=detailAcctChannelPayoutProcess&pkId,batchNo,busiType,fromAccountId,toAccountId,fromChannelAccountId,toChannelAccountId,channelType,payFee,payStatus,createDate,opTime,status,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'AcctChannelPayoutProcess.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,batchNo,busiType,fromAccountId,toAccountId,fromChannelAccountId,toChannelAccountId,channelType,payFee,payStatus,createDate,opTime,status,remark'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ��κ�-->   
								<th align="center" rowName="batchNo" orderName="batch_no:DESC" title='��κ�'>��κ�</th>
								<!-- ������  ҵ������: 1.����ʱ֧��-->   
								<th align="center" rowName="busiType" orderName="busi_type:DESC" title='ҵ������: 1.����ʱ֧��'>ҵ������: 1.����ʱ֧��</th>
								<!-- ������  ֧���˻�ID-->   
