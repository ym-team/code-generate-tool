...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'TSocialKeyword.mc?method=editTSocialKeyword&id,content,status,mark,createTime,modifyTime=',
				del:'TSocialKeyword.mc?method=deleteTSocialKeyword&PK=',
				view:'TSocialKeyword.mc?method=detailTSocialKeyword&id,content,status,mark,createTime,modifyTime='
			};
			var options = {
				tableId:'pageTable',
				url:'TSocialKeyword.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,content,status,mark,createTime,modifyTime'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- 主键列  鏈?鍚庝慨鏀规椂闂?-->   
								<th align="center" rowName="modifyTime" orderName="modify_time:DESC" title='鏈?鍚庝慨鏀规椂闂?'>鏈?鍚庝慨鏀规椂闂?</th>
								<!--表头循环结束 -->	
