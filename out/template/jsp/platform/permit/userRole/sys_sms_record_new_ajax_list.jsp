...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'SysSmsRecordNew.mc?method=editSysSmsRecordNew&pkId,sendUserDeviceId,sendUserId,smsContent,recievePhoneNum,busiType,returnCode,returnMsg,batchId,createDate,opTime,remark,sysType=',
				del:'SysSmsRecordNew.mc?method=deleteSysSmsRecordNew&PK=',
				view:'SysSmsRecordNew.mc?method=detailSysSmsRecordNew&pkId,sendUserDeviceId,sendUserId,smsContent,recievePhoneNum,busiType,returnCode,returnMsg,batchId,createDate,opTime,remark,sysType='
			};
			var options = {
				tableId:'pageTable',
				url:'SysSmsRecordNew.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,sendUserDeviceId,sendUserId,smsContent,recievePhoneNum,busiType,returnCode,returnMsg,batchId,createDate,opTime,remark,sysType'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  �������豸ID-->   
								<th align="center" rowName="sendUserDeviceId" orderName="send_user_device_id:DESC" title='�������豸ID'>�������豸ID</th>
								<!-- ������  ������-->   
								<th align="center" rowName="sendUserId" orderName="send_user_id:DESC" title='������'>������</th>
								<!-- ������  ��������-->   
								<th align="center" rowName="smsContent" orderName="sms_content:DESC" title='��������'>��������</th>
								<!-- ������  ���պ���-->   
								<th align="center" rowName="recievePhoneNum" orderName="recieve_phone_num:DESC" title='���պ���'>���պ���</th>
								<!-- ������  ҵ������ 1:ע��(��֤��) 2�һ�����(��֤��) -->   
								<th align="center" rowName="busiType" orderName="busi_type:DESC" title='ҵ������ 1:ע��(��֤��) 2�һ�����(��֤��) '>ҵ������ 1:ע��(��֤��) 2�һ�����(��֤��) </th>
								<!-- ������  ����ƽ̨��������-->   
								<th align="center" rowName="returnCode" orderName="return_code:DESC" title='����ƽ̨��������'>����ƽ̨��������</th>
								<!-- ������  ����ƽ̨���ر���-->   
								<th align="center" rowName="returnMsg" orderName="return_msg:DESC" title='����ƽ̨���ر���'>����ƽ̨���ر���</th>
								<!-- ������  ������κ�-->   
								<th align="center" rowName="batchId" orderName="batch_id:DESC" title='������κ�'>������κ�</th>
								<!-- ������  ����ʱ��-->   
								...
								<!-- ������  ϵͳ���� 1:���߰� 2:ҽ���-->   
								<th align="center" rowName="sysType" orderName="sys_type:DESC" title='ϵͳ���� 1:���߰� 2:ҽ���'>ϵͳ���� 1:���߰� 2:ҽ���</th>
								<!--��ͷѭ������ -->	
	                    		<th align="center">�� ��</th>                    
							</tr>
						</thead>
