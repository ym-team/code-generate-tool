...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'AcctBusiPaymentProcess.mc?method=editAcctBusiPaymentProcess&pkId,subOrderId,fromAccountId,toAccountId,payFee,payStatus,payDesc,createDate,opTime,status,remark,orderSource=',
				del:'AcctBusiPaymentProcess.mc?method=deleteAcctBusiPaymentProcess&PK=',
				view:'AcctBusiPaymentProcess.mc?method=detailAcctBusiPaymentProcess&pkId,subOrderId,fromAccountId,toAccountId,payFee,payStatus,payDesc,createDate,opTime,status,remark,orderSource='
			};
			var options = {
				tableId:'pageTable',
				url:'AcctBusiPaymentProcess.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,subOrderId,fromAccountId,toAccountId,payFee,payStatus,payDesc,createDate,opTime,status,remark,orderSource'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  11-�½�Ԥ���� 88-ȡ��  99-�����-->   
								<th align="center" rowName="payStatus" orderName="pay_status:DESC" title='11-�½�Ԥ���� 88-ȡ��  99-�����'>11-�½�Ԥ���� 88-ȡ��  99-�����</th>
								<!-- ������  ���ѻ���˵��-->   
								<th align="center" rowName="payDesc" orderName="pay_desc:DESC" title='���ѻ���˵��'>���ѻ���˵��</th>
								<!-- ������  ����ʱ��-->   
