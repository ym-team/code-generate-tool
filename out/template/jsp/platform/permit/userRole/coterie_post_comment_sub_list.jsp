...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoteriePostCommentSub(PK) {
			jQuery.ajax({
				url : "CoteriePostCommentSub.mc?method=deleteCoteriePostCommentSub",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoteriePostCommentSub.mc?method=getAllPageCoteriePostCommentSub" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							CoteriePostCommentSub view = new CoteriePostCommentSub();
								for (int i = 0; i < list.size(); i++) {
									view = (CoteriePostCommentSub) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoteriePostCommentSub.mc?method=editCoteriePostCommentSub&id,fromUserId,commentSubDesc,toUserId,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getFromUserId() +":"+  view.getCommentSubDesc() +":"+  view.getToUserId() +":"+  view.getCommentSubStatus() +":"+  view.getCommentSubType() +":"+  view.getPostId() +":"+  view.getPostChannelType() +":"+  view.getCommentId() +":"+  view.getCommentUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoteriePostCommentSub('<%= view.getId() +":"+  view.getFromUserId() +":"+  view.getCommentSubDesc() +":"+  view.getToUserId() +":"+  view.getCommentSubStatus() +":"+  view.getCommentSubType() +":"+  view.getPostId() +":"+  view.getPostChannelType() +":"+  view.getCommentId() +":"+  view.getCommentUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoteriePostCommentSub.mc?method=detailCoteriePostCommentSub&id,fromUserId,commentSubDesc,toUserId,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getFromUserId() +":"+  view.getCommentSubDesc() +":"+  view.getToUserId() +":"+  view.getCommentSubStatus() +":"+  view.getCommentSubType() +":"+  view.getPostId() +":"+  view.getPostChannelType() +":"+  view.getCommentId() +":"+  view.getCommentUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
