...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteDoctorList(PK) {
			jQuery.ajax({
				url : "DoctorList.mc?method=deleteDoctorList",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/DoctorList.mc?method=getAllPageDoctorList" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/doctor_list_edit.jsp'">���</button>
						</td>
						<td align="right">
								<div class="controls asearch">
						    
						    	<input type='text' class="input-small" name="rowno" placeholder="���ȼ�" value="${ param.rowno }"/>
						    
						    	<input type='text' class="input-small" name="doc_type" placeholder="ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)" value="${ param.doc_type }"/>
						    	...
						    	<input type='text' class="input-small" name="agreement_state" placeholder="�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��" value="${ param.agreement_state }"/>
						    
						    	<input type='text' class="input-small" name="good_at_symptom" placeholder="�ó���״" value="${ param.good_at_symptom }"/>
						    
						    	<input type='text' class="input-small" name="dept_phone" placeholder="���ҵ绰" value="${ param.dept_phone }"/>
						    
						    	<input type='text' class="input-small" name="reserve1" placeholder="�����ֶ�1" value="${ param.reserve1 }"/>
						    
						    	<input type='text' class="input-small" name="reserve2" placeholder="�����ֶ�2" value="${ param.reserve2 }"/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--��ͷѭ����ʼ -->
								<!-- ������{���ȼ�}-->   
								<th align="center" rowName="rowno" orderName="rowno:DESC" title='���ȼ�'>���ȼ�</th>
								<!-- ������{ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)}-->   
								<th align="center" rowName="doc_type" orderName="doc_type:DESC" title='ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)'>ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)</th>
								<!-- ������{�û�ID}-->   
								...
								<!-- ������{�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��}-->   
								<th align="center" rowName="agreement_state" orderName="agreement_state:DESC" title='�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��'>�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��</th>
								<!-- ������{�ó���״}-->   
								<th align="center" rowName="good_at_symptom" orderName="good_at_symptom:DESC" title='�ó���״'>�ó���״</th>
								<!-- ������{���ҵ绰}-->   
								<th align="center" rowName="dept_phone" orderName="dept_phone:DESC" title='���ҵ绰'>���ҵ绰</th>
								<!-- ������{�����ֶ�1}-->   
								<th align="center" rowName="reserve1" orderName="reserve1:DESC" title='�����ֶ�1'>�����ֶ�1</th>
								<!-- ������{�����ֶ�2}-->   
								<th align="center" rowName="reserve2" orderName="reserve2:DESC" title='�����ֶ�2'>�����ֶ�2</th>
								<!-- ������{���˼��}-->   
						...
						<%
							...
							DoctorList view = new DoctorList();
								for (int i = 0; i < list.size(); i++) {
									view = (DoctorList) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<!-- ������{�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��}-->   
											<td><%=view.getAgreementState()%></td>
											<!-- ������{�ó���״}-->   
											<td><%=view.getGoodAtSymptom()%></td>
											<!-- ������{���ҵ绰}-->   
											<td><%=view.getDeptPhone()%></td>
											<!-- ������{�����ֶ�1}-->   
											<td><%=view.getReserve1()%></td>
											<!-- ������{�����ֶ�2}-->   
											<td><%=view.getReserve2()%></td>
											<!-- ������{���˼��}-->   
											...
											<td>
												<a class="o-edit" href="DoctorList.mc?method=editDoctorList&rowno,docType,userSeqId,userName,userType,sex,birthdate,province,cityCode,companyId,companyName,deptId,deptName,educationLevel,entrySchoolDate,mediaType,professionalTitle,jobTitle,userLevel,userFaceUrl,opTime,remark,agreementState,goodAtSymptom,deptPhone,reserve1,reserve2,userBrifeDesc,adviceNum=<%= view.getRowno() +":"+  view.getDocType() +":"+  view.getUserSeqId() +":"+  view.getUserName() +":"+  view.getUserType() +":"+  view.getSex() +":"+  view.getBirthdate() +":"+  view.getProvince() +":"+  view.getCityCode() +":"+  view.getCompanyId() +":"+  view.getCompanyName() +":"+  view.getDeptId() +":"+  view.getDeptName() +":"+  view.getEducationLevel() +":"+  view.getEntrySchoolDate() +":"+  view.getMediaType() +":"+  view.getProfessionalTitle() +":"+  view.getJobTitle() +":"+  view.getUserLevel() +":"+  view.getUserFaceUrl() +":"+  view.getOpTime() +":"+  view.getRemark() +":"+  view.getAgreementState() +":"+  view.getGoodAtSymptom() +":"+  view.getDeptPhone() +":"+  view.getReserve1() +":"+  view.getReserve2() +":"+  view.getUserBrifeDesc() +":"+  view.getAdviceNum() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteDoctorList('<%= view.getRowno() +":"+  view.getDocType() +":"+  view.getUserSeqId() +":"+  view.getUserName() +":"+  view.getUserType() +":"+  view.getSex() +":"+  view.getBirthdate() +":"+  view.getProvince() +":"+  view.getCityCode() +":"+  view.getCompanyId() +":"+  view.getCompanyName() +":"+  view.getDeptId() +":"+  view.getDeptName() +":"+  view.getEducationLevel() +":"+  view.getEntrySchoolDate() +":"+  view.getMediaType() +":"+  view.getProfessionalTitle() +":"+  view.getJobTitle() +":"+  view.getUserLevel() +":"+  view.getUserFaceUrl() +":"+  view.getOpTime() +":"+  view.getRemark() +":"+  view.getAgreementState() +":"+  view.getGoodAtSymptom() +":"+  view.getDeptPhone() +":"+  view.getReserve1() +":"+  view.getReserve2() +":"+  view.getUserBrifeDesc() +":"+  view.getAdviceNum() %>')" title="ɾ��"></a>
											    <a class="o-view" href="DoctorList.mc?method=detailDoctorList&rowno,docType,userSeqId,userName,userType,sex,birthdate,province,cityCode,companyId,companyName,deptId,deptName,educationLevel,entrySchoolDate,mediaType,professionalTitle,jobTitle,userLevel,userFaceUrl,opTime,remark,agreementState,goodAtSymptom,deptPhone,reserve1,reserve2,userBrifeDesc,adviceNum=<%= view.getRowno() +":"+  view.getDocType() +":"+  view.getUserSeqId() +":"+  view.getUserName() +":"+  view.getUserType() +":"+  view.getSex() +":"+  view.getBirthdate() +":"+  view.getProvince() +":"+  view.getCityCode() +":"+  view.getCompanyId() +":"+  view.getCompanyName() +":"+  view.getDeptId() +":"+  view.getDeptName() +":"+  view.getEducationLevel() +":"+  view.getEntrySchoolDate() +":"+  view.getMediaType() +":"+  view.getProfessionalTitle() +":"+  view.getJobTitle() +":"+  view.getUserLevel() +":"+  view.getUserFaceUrl() +":"+  view.getOpTime() +":"+  view.getRemark() +":"+  view.getAgreementState() +":"+  view.getGoodAtSymptom() +":"+  view.getDeptPhone() +":"+  view.getReserve1() +":"+  view.getReserve2() +":"+  view.getUserBrifeDesc() +":"+  view.getAdviceNum() %>" title="����"></a> 
