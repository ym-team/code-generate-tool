...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoterieDoctorCopy.mc?method=editCoterieDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId=',
				del:'CoterieDoctorCopy.mc?method=deleteCoterieDoctorCopy&PK=',
				view:'CoterieDoctorCopy.mc?method=detailCoterieDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId='
			};
			var options = {
				tableId:'pageTable',
				url:'CoterieDoctorCopy.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId'
			};
