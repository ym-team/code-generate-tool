...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoterieDoctor(PK) {
			jQuery.ajax({
				url : "CoterieDoctor.mc?method=deleteCoterieDoctor",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoterieDoctor.mc?method=getAllPageCoterieDoctor" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							CoterieDoctor view = new CoterieDoctor();
								for (int i = 0; i < list.size(); i++) {
									view = (CoterieDoctor) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoterieDoctor.mc?method=editCoterieDoctor&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,memberCount,subSystemType,systemType,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieType() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateUserId() +":"+  view.getMemberCount() +":"+  view.getSubSystemType() +":"+  view.getSystemType() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoterieDoctor('<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieType() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateUserId() +":"+  view.getMemberCount() +":"+  view.getSubSystemType() +":"+  view.getSystemType() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoterieDoctor.mc?method=detailCoterieDoctor&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,memberCount,subSystemType,systemType,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieType() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateUserId() +":"+  view.getMemberCount() +":"+  view.getSubSystemType() +":"+  view.getSystemType() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
