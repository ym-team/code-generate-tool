...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'TPmExceptionToPreypayRecord.mc?method=editTPmExceptionToPreypayRecord&exceptionPrepayId,exceptionBillCode,ncPrepayId,ncPrepayTime,ncPrepayName,ncPrepayMoney,ncStatus,optUserId,updateTime,createTime,remark=',
				del:'TPmExceptionToPreypayRecord.mc?method=deleteTPmExceptionToPreypayRecord&PK=',
				view:'TPmExceptionToPreypayRecord.mc?method=detailTPmExceptionToPreypayRecord&exceptionPrepayId,exceptionBillCode,ncPrepayId,ncPrepayTime,ncPrepayName,ncPrepayMoney,ncStatus,optUserId,updateTime,createTime,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'TPmExceptionToPreypayRecord.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'exceptionPrepayId,exceptionBillCode,ncPrepayId,ncPrepayTime,ncPrepayName,ncPrepayMoney,ncStatus,optUserId,updateTime,createTime,remark'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--表头循环开始 -->
								<!-- 主键列  寮傚父杞敮浠樿褰曚富閿?-->   
								<th align="center" rowName="exceptionPrepayId" orderName="exception_prepay_id:DESC" title='寮傚父杞敮浠樿褰曚富閿?'>寮傚父杞敮浠樿褰曚富閿?</th>
								<!-- 主键列  寮傚父鍗曡〃billcode-->   
