...
<body class="bgcolor3">
	<%
		DiscoverPushOfficeOrderView vo = (DiscoverPushOfficeOrderView) request.getAttribute("DiscoverPushOfficeOrder");
		if (vo == null) {
			vo = new DiscoverPushOfficeOrderView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="DiscoverPushOfficeOrder.mc?method=updateDiscoverPushOfficeOrderJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='DiscoverPushOfficeOrder.mc?method=getAllPageDiscoverPushOfficeOrder&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
