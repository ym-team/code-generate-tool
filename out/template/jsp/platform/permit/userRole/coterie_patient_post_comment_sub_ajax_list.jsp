...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePatientPostCommentSub.mc?method=editCoteriePatientPostCommentSub&id,fromUserId,fromChannelType,commentSubDesc,toUserId,toChannelType,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,commentChannelType,createTime,optTime,remark,char1=',
				del:'CoteriePatientPostCommentSub.mc?method=deleteCoteriePatientPostCommentSub&PK=',
				view:'CoteriePatientPostCommentSub.mc?method=detailCoteriePatientPostCommentSub&id,fromUserId,fromChannelType,commentSubDesc,toUserId,toChannelType,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,commentChannelType,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePatientPostCommentSub.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,fromUserId,fromChannelType,commentSubDesc,toUserId,toChannelType,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,commentChannelType,createTime,optTime,remark,char1'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  �û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp-->   
								<th align="center" rowName="fromChannelType" orderName="from_channel_type:DESC" title='�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp'>�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp</th>
								<!-- ������  �ظ�����-->   
								<th align="center" rowName="commentSubDesc" orderName="comment_sub_desc:DESC" title='�ظ�����'>�ظ�����</th>
								<!-- ������  ��������id-->   
								<th align="center" rowName="toUserId" orderName="to_user_id:DESC" title='��������id'>��������id</th>
								<!-- ������  �û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp-->   
								<th align="center" rowName="toChannelType" orderName="to_channel_type:DESC" title='�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp'>�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp</th>
								<!-- ������  ��δ����-->   
								<th align="center" rowName="commentSubStatus" orderName="comment_sub_status:DESC" title='��δ����'>��δ����</th>
								<!-- ������  1 ֱ�ӻظ�������  2 �ظ�������-->   
								<th align="center" rowName="commentSubType" orderName="comment_sub_type:DESC" title='1 ֱ�ӻظ�������  2 �ظ�������'>1 ֱ�ӻظ�������  2 �ظ�������</th>
								<!-- ������  ����id-->   
								<th align="center" rowName="postId" orderName="post_id:DESC" title='����id'>����id</th>
								<!-- ������  1 Ȧ�� 2ƽ̨-->   
								<th align="center" rowName="postChannelType" orderName="post_channel_type:DESC" title='1 Ȧ�� 2ƽ̨'>1 Ȧ�� 2ƽ̨</th>
								<!-- ������  ����id-->   
								<th align="center" rowName="commentId" orderName="comment_id:DESC" title='����id'>����id</th>
								<!-- ������  ������id-->   
								<th align="center" rowName="commentUserId" orderName="comment_user_id:DESC" title='������id'>������id</th>
								<!-- ������  �û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp-->   
								<th align="center" rowName="commentChannelType" orderName="comment_channel_type:DESC" title='�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp'>�û����� 1 ľ�޽��� 2 ��У���� 3 ��Уapp</th>
								<!-- ������  ����ʱ��-->   
