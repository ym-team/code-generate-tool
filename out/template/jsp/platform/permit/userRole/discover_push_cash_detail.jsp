...
<body class="bgcolor3">
	<%
		DiscoverPushCashView vo = (DiscoverPushCashView) request.getAttribute("DiscoverPushCash");
		if (vo == null) {
			vo = new DiscoverPushCashView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="DiscoverPushCash.mc?method=updateDiscoverPushCashJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='DiscoverPushCash.mc?method=getAllPageDiscoverPushCash&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
