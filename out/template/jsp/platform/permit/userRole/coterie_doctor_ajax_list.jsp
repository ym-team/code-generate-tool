...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoterieDoctor.mc?method=editCoterieDoctor&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,memberCount,subSystemType,systemType,createTime,optTime,remark,char1=',
				del:'CoterieDoctor.mc?method=deleteCoterieDoctor&PK=',
				view:'CoterieDoctor.mc?method=detailCoterieDoctor&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,memberCount,subSystemType,systemType,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoterieDoctor.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,memberCount,subSystemType,systemType,createTime,optTime,remark,char1'
			};
			...
			<div class="title-common">
				...
				<div class="control-group">
					<table id="tblSearch" width="100%" id="sa1" border="0" cellpadding="0" cellspacing="0">
						<tr class="theight">
						 <td >
						 <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_doctor_edit.jsp'">���</button>
						 </td>
						  <td align="right">
