...
<body class="bgcolor3">
	<%
		TPmExceptionToPreypayRecordView vo = (TPmExceptionToPreypayRecordView) request.getAttribute("TPmExceptionToPreypayRecord");
		if (vo == null) {
			vo = new TPmExceptionToPreypayRecordView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="TPmExceptionToPreypayRecord.mc?method=updateTPmExceptionToPreypayRecordJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='TPmExceptionToPreypayRecord.mc?method=getAllPageTPmExceptionToPreypayRecord&start=0&pageSize=10'" value="返回" />
					</td>
				</tr>
			</table>
		</form>
