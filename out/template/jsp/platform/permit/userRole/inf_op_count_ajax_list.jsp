...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'InfOpCount.mc?method=editInfOpCount&infId,forwardNum,likeNum,commentNum=',
				del:'InfOpCount.mc?method=deleteInfOpCount&PK=',
				view:'InfOpCount.mc?method=detailInfOpCount&infId,forwardNum,likeNum,commentNum='
			};
			var options = {
				tableId:'pageTable',
				url:'InfOpCount.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'infId,forwardNum,likeNum,commentNum'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--��ͷѭ����ʼ -->
								<!-- ������  ��Ѷ��Ϣ��ʶ-->   
								<th align="center" rowName="infId" orderName="inf_id:DESC" title='��Ѷ��Ϣ��ʶ'>��Ѷ��Ϣ��ʶ</th>
								<!-- ������  ת������, ÿ������ת��ʱ, +1����-->   
								<th align="center" rowName="forwardNum" orderName="forward_num:DESC" title='ת������, ÿ������ת��ʱ, +1����'>ת������, ÿ������ת��ʱ, +1����</th>
								<!-- ������  ��������, ÿ�����˵���ʱ, +1����-->   
								<th align="center" rowName="likeNum" orderName="like_num:DESC" title='��������, ÿ�����˵���ʱ, +1����'>��������, ÿ�����˵���ʱ, +1����</th>
								<!-- ������  ��������, ÿ����������ʱʱ, +1����-->   
								<th align="center" rowName="commentNum" orderName="comment_num:DESC" title='��������, ÿ����������ʱʱ, +1����'>��������, ÿ����������ʱʱ, +1����</th>
								<!--��ͷѭ������ -->	
	                    		<th align="center">�� ��</th>                    
							</tr>
						</thead>
