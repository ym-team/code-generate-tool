...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePatientMember.mc?method=editCoteriePatientMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1,channelType,postCount,likeCount,forwardCount=',
				del:'CoteriePatientMember.mc?method=deleteCoteriePatientMember&PK=',
				view:'CoteriePatientMember.mc?method=detailCoteriePatientMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1,channelType,postCount,likeCount,forwardCount='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePatientMember.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1,channelType,postCount,likeCount,forwardCount'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ 5 �˳� 6 �߳�-->   
								<th align="center" rowName="memberStatus" orderName="member_status:DESC" title='1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ 5 �˳� 6 �߳�'>1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ 5 �˳� 6 �߳�</th>
								<!-- ������  1.����Ա  2.��Ա-->   
								<th align="center" rowName="memberType" orderName="member_type:DESC" title='1.����Ա  2.��Ա'>1.����Ա  2.��Ա</th>
								<!-- ������  Ȧ��id-->   
