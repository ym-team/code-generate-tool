...
<body class="bgcolor3">
	<%
		DiscoverPushPatientJxjkAdviceView vo = (DiscoverPushPatientJxjkAdviceView) request.getAttribute("DiscoverPushPatientJxjkAdvice");
		if (vo == null) {
			vo = new DiscoverPushPatientJxjkAdviceView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="DiscoverPushPatientJxjkAdvice.mc?method=updateDiscoverPushPatientJxjkAdviceJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='DiscoverPushPatientJxjkAdvice.mc?method=getAllPageDiscoverPushPatientJxjkAdvice&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
