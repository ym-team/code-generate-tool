...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'UserCmccDoctorMoney.mc?method=editUserCmccDoctorMoney&id,adviceId,patientId,doctorId,comboId,income,moneyStatus,payChannelType,channelType,createTime,optTime,remark,char1,char2=',
				del:'UserCmccDoctorMoney.mc?method=deleteUserCmccDoctorMoney&PK=',
				view:'UserCmccDoctorMoney.mc?method=detailUserCmccDoctorMoney&id,adviceId,patientId,doctorId,comboId,income,moneyStatus,payChannelType,channelType,createTime,optTime,remark,char1,char2='
			};
			var options = {
				tableId:'pageTable',
				url:'UserCmccDoctorMoney.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,adviceId,patientId,doctorId,comboId,income,moneyStatus,payChannelType,channelType,createTime,optTime,remark,char1,char2'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ��ѯid-->   
								<th align="center" rowName="adviceId" orderName="advice_id:DESC" title='��ѯid'>��ѯid</th>
								<!-- ������  �û�id-->   
								...
								<!-- ������  ����״̬ 1 �ѽ��� 2 δ����-->   
								<th align="center" rowName="moneyStatus" orderName="money_status:DESC" title='����״̬ 1 �ѽ��� 2 δ����'>����״̬ 1 �ѽ��� 2 δ����</th>
								<!-- ������  ����֧������ 1 ΢�� 2 ֧���� 3����-->   
								<th align="center" rowName="payChannelType" orderName="pay_channel_type:DESC" title='����֧������ 1 ΢�� 2 ֧���� 3����'>����֧������ 1 ΢�� 2 ֧���� 3����</th>
								<!-- ������  ������Դ APP,CMCC,BOC-->   
								<th align="center" rowName="channelType" orderName="channel_type:DESC" title='������Դ APP,CMCC,BOC'>������Դ APP,CMCC,BOC</th>
								<!-- ������  ����ʱ��-->   
