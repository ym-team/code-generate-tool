...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'AcctUserAccount.mc?method=editAcctUserAccount&accountId,userId,password,accountType,createDate,opTime,status,remark=',
				del:'AcctUserAccount.mc?method=deleteAcctUserAccount&PK=',
				view:'AcctUserAccount.mc?method=detailAcctUserAccount&accountId,userId,password,accountType,createDate,opTime,status,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'AcctUserAccount.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'accountId,userId,password,accountType,createDate,opTime,status,remark'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--��ͷѭ����ʼ -->
								<!-- ������  �˻�ID:USER_ID+01             -->   
								<th align="center" rowName="accountId" orderName="account_id:DESC" title='�˻�ID:USER_ID+01             '>�˻�ID:USER_ID+01             </th>
								<!-- ������  �û�ID-->   
								...
								<!-- ������  0 ��ͨ�˻�             1 ϵͳ�ʻ�-->   
								<th align="center" rowName="accountType" orderName="account_type:DESC" title='0 ��ͨ�˻�             1 ϵͳ�ʻ�'>0 ��ͨ�˻�             1 ϵͳ�ʻ�</th>
								<!-- ������  ����ʱ��-->   
