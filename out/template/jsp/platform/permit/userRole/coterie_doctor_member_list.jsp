...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoterieDoctorMember(PK) {
			jQuery.ajax({
				url : "CoterieDoctorMember.mc?method=deleteCoterieDoctorMember",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoterieDoctorMember.mc?method=getAllPageCoterieDoctorMember" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_doctor_member_edit.jsp'">���</button>
						</td>
						<td align="right">
						    	...
						    	<input type='text' class="input-small" name="member_status" placeholder="1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ" value="${ param.member_status }"/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������{1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ}-->   
								<th align="center" rowName="member_status" orderName="member_status:DESC" title='1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ'>1.������  2.�ɹ�   3.�ܾ�   4. ��ɢ</th>
								<!-- ������{1.����Ա  2.��Ա}-->   
						...
						<%
							...
							CoterieDoctorMember view = new CoterieDoctorMember();
								for (int i = 0; i < list.size(); i++) {
									view = (CoterieDoctorMember) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoterieDoctorMember.mc?method=editCoterieDoctorMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getMemberId() +":"+  view.getMemberStatus() +":"+  view.getMemberType() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoterieDoctorMember('<%= view.getId() +":"+  view.getMemberId() +":"+  view.getMemberStatus() +":"+  view.getMemberType() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoterieDoctorMember.mc?method=detailCoterieDoctorMember&id,memberId,memberStatus,memberType,coterieId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getMemberId() +":"+  view.getMemberStatus() +":"+  view.getMemberType() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
