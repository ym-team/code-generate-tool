...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'TPmHousePrepayHistoryTest.mc?method=editTPmHousePrepayHistoryTest&pkId,houseId,prepayCategoryId,dbUpdateTime=',
				del:'TPmHousePrepayHistoryTest.mc?method=deleteTPmHousePrepayHistoryTest&PK=',
				view:'TPmHousePrepayHistoryTest.mc?method=detailTPmHousePrepayHistoryTest&pkId,houseId,prepayCategoryId,dbUpdateTime='
			};
			var options = {
				tableId:'pageTable',
				url:'TPmHousePrepayHistoryTest.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,houseId,prepayCategoryId,dbUpdateTime'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- 主键列  鎴夸骇涓婚敭-->   
								<th align="center" rowName="houseId" orderName="house_id:DESC" title='鎴夸骇涓婚敭'>鎴夸骇涓婚敭</th>
								<!-- 主键列  鏀惰垂椤圭洰ID-->   
								<th align="center" rowName="prepayCategoryId" orderName="prepay_category_id:DESC" title='鏀惰垂椤圭洰ID'>鏀惰垂椤圭洰ID</th>
								<!-- 主键列  db鏇存柊鏃堕棿-->   
								<th align="center" rowName="dbUpdateTime" orderName="db_update_time:DESC" title='db鏇存柊鏃堕棿'>db鏇存柊鏃堕棿</th>
								<!--表头循环结束 -->	
