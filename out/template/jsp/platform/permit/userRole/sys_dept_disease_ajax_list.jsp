...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'SysDeptDisease.mc?method=editSysDeptDisease&deptId,diseaseId,diseaseName,source,status=',
				del:'SysDeptDisease.mc?method=deleteSysDeptDisease&PK=',
				view:'SysDeptDisease.mc?method=detailSysDeptDisease&deptId,diseaseId,diseaseName,source,status='
			};
			var options = {
				tableId:'pageTable',
				url:'SysDeptDisease.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'deptId,diseaseId,diseaseName,source,status'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ����ID-->   
								<th align="center" rowName="diseaseId" orderName="disease_id:DESC" title='����ID'>����ID</th>
								<!-- ������  �������-->   
								<th align="center" rowName="diseaseName" orderName="disease_name:DESC" title='�������'>�������</th>
								<!-- ������  ��Դ  ϵͳ���, �û����-->   
