...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePostCommentSub.mc?method=editCoteriePostCommentSub&id,fromUserId,commentSubDesc,toUserId,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,createTime,optTime,remark,char1=',
				del:'CoteriePostCommentSub.mc?method=deleteCoteriePostCommentSub&PK=',
				view:'CoteriePostCommentSub.mc?method=detailCoteriePostCommentSub&id,fromUserId,commentSubDesc,toUserId,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePostCommentSub.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,fromUserId,commentSubDesc,toUserId,commentSubStatus,commentSubType,postId,postChannelType,commentId,commentUserId,createTime,optTime,remark,char1'
			};
			...
			<div class="title-common">
				...
				<div class="control-group">
					<table id="tblSearch" width="100%" id="sa1" border="0" cellpadding="0" cellspacing="0">
						<tr class="theight">
						 <td >
						 <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_post_comment_sub_edit.jsp'">���</button>
						 </td>
						  <td align="right">
