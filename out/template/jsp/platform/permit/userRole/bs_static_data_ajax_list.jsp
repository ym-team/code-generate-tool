...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'BsStaticData.mc?method=editBsStaticData&codeType,codeValue,codeName,codeDesc,codeTypeAlias,sortId,state,externCodeType=',
				del:'BsStaticData.mc?method=deleteBsStaticData&PK=',
				view:'BsStaticData.mc?method=detailBsStaticData&codeType,codeValue,codeName,codeDesc,codeTypeAlias,sortId,state,externCodeType='
			};
			var options = {
				tableId:'pageTable',
				url:'BsStaticData.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
