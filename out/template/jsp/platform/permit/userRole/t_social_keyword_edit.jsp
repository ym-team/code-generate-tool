     ...
     <span class="red1">*</span> 
				...
				<tr>
					...
					<td height="60">
						...
						<input type="button" class="btn-return" onclick="javascript:window.location.href='${contextPath}/TSocialKeyword.mc?method=getAllPageTSocialKeyword'" value="返回" />
					</td>
				</tr>
			</table>
		</form>
