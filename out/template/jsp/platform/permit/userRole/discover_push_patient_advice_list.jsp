...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteDiscoverPushPatientAdvice(PK) {
			jQuery.ajax({
				url : "DiscoverPushPatientAdvice.mc?method=deleteDiscoverPushPatientAdvice",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/DiscoverPushPatientAdvice.mc?method=getAllPageDiscoverPushPatientAdvice" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/discover_push_patient_advice_edit.jsp'">���</button>
						</td>
						<td align="right">
						    	...
						    	<input type='text' class="input-small" name="inner_push_type" placeholder="������" value="${ param.inner_push_type }"/>
						    
						    	<input type='text' class="input-small" name="inner_push_sub_type" placeholder="������" value="${ param.inner_push_sub_type }"/>
						    	...
						    	<input type='text' class="input-small" name="push_service_msg_status" placeholder="�¼�״̬" value="${ param.push_service_msg_status }"/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������{������}-->   
								<th align="center" rowName="inner_push_type" orderName="inner_push_type:DESC" title='������'>������</th>
								<!-- ������{������}-->   
								<th align="center" rowName="inner_push_sub_type" orderName="inner_push_sub_type:DESC" title='������'>������</th>
								<!-- ������{���ͱ���}-->   
								...
								<!-- ������{�¼�״̬}-->   
								<th align="center" rowName="push_service_msg_status" orderName="push_service_msg_status:DESC" title='�¼�״̬'>�¼�״̬</th>
								<!-- ������{����ʱ��}-->   
						...
						<%
							...
							DiscoverPushPatientAdvice view = new DiscoverPushPatientAdvice();
								for (int i = 0; i < list.size(); i++) {
									view = (DiscoverPushPatientAdvice) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
