...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'AcctAccountBalanceRt.mc?method=editAcctAccountBalanceRt&accountId,availableBalance,freezeBalance,preIncome,preOutcome,createDate,opTime,status,remark=',
				del:'AcctAccountBalanceRt.mc?method=deleteAcctAccountBalanceRt&PK=',
				view:'AcctAccountBalanceRt.mc?method=detailAcctAccountBalanceRt&accountId,availableBalance,freezeBalance,preIncome,preOutcome,createDate,opTime,status,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'AcctAccountBalanceRt.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'accountId,availableBalance,freezeBalance,preIncome,preOutcome,createDate,opTime,status,remark'
			};
