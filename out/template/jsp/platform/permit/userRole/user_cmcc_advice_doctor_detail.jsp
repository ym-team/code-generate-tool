...
<body class="bgcolor3">
	<%
		UserCmccAdviceDoctorView vo = (UserCmccAdviceDoctorView) request.getAttribute("UserCmccAdviceDoctor");
		if (vo == null) {
			vo = new UserCmccAdviceDoctorView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="UserCmccAdviceDoctor.mc?method=updateUserCmccAdviceDoctorJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td class="titleright">��ѯ�����쿪ʼʱ�� ��</td>
					<td>
						<%=vo.getAdviceStartTime()%>
   					</td>
				</tr>
				<tr>
					<td class="titleright">��ѯ������ʱ�� ��</td>
					<td>
						<%=vo.getAdviceValidTime()%>
   					</td>
				</tr>
				<!-- end:��Ϣ¼�벿�� -->
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='UserCmccAdviceDoctor.mc?method=getAllPageUserCmccAdviceDoctor&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
