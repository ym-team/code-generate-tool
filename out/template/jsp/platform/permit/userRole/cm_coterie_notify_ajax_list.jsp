...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CmCoterieNotify.mc?method=editCmCoterieNotify&pkId,coterieId,createUserId,notifyUserId,objUserId,createDate,notifyType,status,opTime,remark=',
				del:'CmCoterieNotify.mc?method=deleteCmCoterieNotify&PK=',
				view:'CmCoterieNotify.mc?method=detailCmCoterieNotify&pkId,coterieId,createUserId,notifyUserId,objUserId,createDate,notifyType,status,opTime,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'CmCoterieNotify.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,coterieId,createUserId,notifyUserId,objUserId,createDate,notifyType,status,opTime,remark'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  Ȧ�Ӵ�����-->   
								<th align="center" rowName="createUserId" orderName="create_user_id:DESC" title='Ȧ�Ӵ�����'>Ȧ�Ӵ�����</th>
								<!-- ������  ������ID-->   
								<th align="center" rowName="notifyUserId" orderName="notify_user_id:DESC" title='������ID'>������ID</th>
								<!-- ������  Ŀ���û�ID-->   
								...
								<th align="center" rowName="notifyType" orderName="notify_type:DESC" title='Ȧ��֪ͨ����:               11: �������Ȧ��              12: �������Ȧ��              13: ͬ�����Ȧ��             14: ����Ȧ�ӳɹ�             21: ��Ա�˳�             22: Ⱥ���߳���Ա             23: ��ɢȦ��'>Ȧ��֪ͨ����:               11: �������Ȧ��              12: �������Ȧ��              13: ͬ�����Ȧ��             14: ����Ȧ�ӳɹ�             21: ��Ա�˳�             22: Ⱥ���߳���Ա             23: ��ɢȦ��</th>
								<!-- ������  0:  ��Ч             1:  ��Ч             -->   
