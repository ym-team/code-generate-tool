...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'OrderComplainReply.mc?method=editOrderComplainReply&id,fromUserId,orderId,orderComplainId,replyContent,complainUserId,complainUserName,createTime,optTime,remark,char1,char2,replyId,replyName=',
				del:'OrderComplainReply.mc?method=deleteOrderComplainReply&PK=',
				view:'OrderComplainReply.mc?method=detailOrderComplainReply&id,fromUserId,orderId,orderComplainId,replyContent,complainUserId,complainUserName,createTime,optTime,remark,char1,char2,replyId,replyName='
			};
			var options = {
				tableId:'pageTable',
				url:'OrderComplainReply.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,fromUserId,orderId,orderComplainId,replyContent,complainUserId,complainUserName,createTime,optTime,remark,char1,char2,replyId,replyName'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  Ͷ��id-->   
								<th align="center" rowName="orderComplainId" orderName="order_complain_id:DESC" title='Ͷ��id'>Ͷ��id</th>
								<!-- ������  �ظ�����-->   
								<th align="center" rowName="replyContent" orderName="reply_content:DESC" title='�ظ�����'>�ظ�����</th>
								<!-- ������  Ͷ����id-->   
								<th align="center" rowName="complainUserId" orderName="complain_user_id:DESC" title='Ͷ����id'>Ͷ����id</th>
								<!-- ������  Ͷ�������-->   
								<th align="center" rowName="complainUserName" orderName="complain_user_name:DESC" title='Ͷ�������'>Ͷ�������</th>
								<!-- ������  ����ʱ��-->   
								...
								<!-- ������  �ظ���id-->   
								<th align="center" rowName="replyId" orderName="reply_id:DESC" title='�ظ���id'>�ظ���id</th>
								<!-- ������  �ظ������-->   
								<th align="center" rowName="replyName" orderName="reply_name:DESC" title='�ظ������'>�ظ������</th>
								<!--��ͷѭ������ -->	
	                    		<th align="center">�� ��</th>                    
							</tr>
						</thead>
