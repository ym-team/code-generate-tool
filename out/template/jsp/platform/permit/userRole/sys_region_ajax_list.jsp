...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'SysRegion.mc?method=editSysRegion&provinceCode,provinceName,cityCode,cityName,countyCode,countyName=',
				del:'SysRegion.mc?method=deleteSysRegion&PK=',
				view:'SysRegion.mc?method=detailSysRegion&provinceCode,provinceName,cityCode,cityName,countyCode,countyName='
			};
			var options = {
				tableId:'pageTable',
				url:'SysRegion.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'provinceCode,provinceName,cityCode,cityName,countyCode,countyName'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--��ͷѭ����ʼ -->
								<!-- ������  ?-->   
								<th align="center" rowName="provinceCode" orderName="province_code:DESC" title='?'>?</th>
								<!-- ������  ?-->   
								<th align="center" rowName="provinceName" orderName="province_name:DESC" title='?'>?</th>
								<!-- ������  -->   
								<th align="center" rowName="cityCode" orderName="city_code:DESC" title=''></th>
								<!-- ������  -->   
								<th align="center" rowName="cityName" orderName="city_name:DESC" title=''></th>
								<!-- ������  -->   
								<th align="center" rowName="countyCode" orderName="county_code:DESC" title=''></th>
								<!-- ������  -->   
								<th align="center" rowName="countyName" orderName="county_name:DESC" title=''></th>
								<!--��ͷѭ������ -->	
	                    		<th align="center">�� ��</th>                    
							</tr>
						</thead>
