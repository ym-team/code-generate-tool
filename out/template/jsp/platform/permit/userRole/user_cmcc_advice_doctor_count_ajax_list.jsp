...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'UserCmccAdviceDoctorCount.mc?method=editUserCmccAdviceDoctorCount&id,doctorId,adviceNum,createTime,optTime,remark=',
				del:'UserCmccAdviceDoctorCount.mc?method=deleteUserCmccAdviceDoctorCount&PK=',
				view:'UserCmccAdviceDoctorCount.mc?method=detailUserCmccAdviceDoctorCount&id,doctorId,adviceNum,createTime,optTime,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'UserCmccAdviceDoctorCount.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,doctorId,adviceNum,createTime,optTime,remark'
			};
