...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteAcctBusiPaymentProcess(PK) {
			jQuery.ajax({
				url : "AcctBusiPaymentProcess.mc?method=deleteAcctBusiPaymentProcess",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/AcctBusiPaymentProcess.mc?method=getAllPageAcctBusiPaymentProcess" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/acct_busi_payment_process_edit.jsp'">���</button>
						</td>
						<td align="right">
						    	...
						    	<input type='text' class="input-small" name="pay_status" placeholder="11-�½�Ԥ���� 88-ȡ��  99-�����" value="${ param.pay_status }"/>
						    
						    	<input type='text' class="input-small" name="pay_desc" placeholder="���ѻ���˵��" value="${ param.pay_desc }"/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������{11-�½�Ԥ���� 88-ȡ��  99-�����}-->   
								<th align="center" rowName="pay_status" orderName="pay_status:DESC" title='11-�½�Ԥ���� 88-ȡ��  99-�����'>11-�½�Ԥ���� 88-ȡ��  99-�����</th>
								<!-- ������{���ѻ���˵��}-->   
								<th align="center" rowName="pay_desc" orderName="pay_desc:DESC" title='���ѻ���˵��'>���ѻ���˵��</th>
								<!-- ������{����ʱ��}-->   
						...
						<%
							...
							AcctBusiPaymentProcess view = new AcctBusiPaymentProcess();
								for (int i = 0; i < list.size(); i++) {
									view = (AcctBusiPaymentProcess) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="AcctBusiPaymentProcess.mc?method=editAcctBusiPaymentProcess&pkId,subOrderId,fromAccountId,toAccountId,payFee,payStatus,payDesc,createDate,opTime,status,remark,orderSource=<%= view.getPkId() +":"+  view.getSubOrderId() +":"+  view.getFromAccountId() +":"+  view.getToAccountId() +":"+  view.getPayFee() +":"+  view.getPayStatus() +":"+  view.getPayDesc() +":"+  view.getCreateDate() +":"+  view.getOpTime() +":"+  view.getStatus() +":"+  view.getRemark() +":"+  view.getOrderSource() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteAcctBusiPaymentProcess('<%= view.getPkId() +":"+  view.getSubOrderId() +":"+  view.getFromAccountId() +":"+  view.getToAccountId() +":"+  view.getPayFee() +":"+  view.getPayStatus() +":"+  view.getPayDesc() +":"+  view.getCreateDate() +":"+  view.getOpTime() +":"+  view.getStatus() +":"+  view.getRemark() +":"+  view.getOrderSource() %>')" title="ɾ��"></a>
											    <a class="o-view" href="AcctBusiPaymentProcess.mc?method=detailAcctBusiPaymentProcess&pkId,subOrderId,fromAccountId,toAccountId,payFee,payStatus,payDesc,createDate,opTime,status,remark,orderSource=<%= view.getPkId() +":"+  view.getSubOrderId() +":"+  view.getFromAccountId() +":"+  view.getToAccountId() +":"+  view.getPayFee() +":"+  view.getPayStatus() +":"+  view.getPayDesc() +":"+  view.getCreateDate() +":"+  view.getOpTime() +":"+  view.getStatus() +":"+  view.getRemark() +":"+  view.getOrderSource() %>" title="����"></a> 
