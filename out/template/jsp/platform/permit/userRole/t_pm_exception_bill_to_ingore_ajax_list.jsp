...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'TPmExceptionBillToIngore.mc?method=editTPmExceptionBillToIngore&pkId,joinId,billCode,optTime,ingoreReason,status,optUserId,dbUpdateTime,dbCreateTime,remark=',
				del:'TPmExceptionBillToIngore.mc?method=deleteTPmExceptionBillToIngore&PK=',
				view:'TPmExceptionBillToIngore.mc?method=detailTPmExceptionBillToIngore&pkId,joinId,billCode,optTime,ingoreReason,status,optUserId,dbUpdateTime,dbCreateTime,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'TPmExceptionBillToIngore.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
