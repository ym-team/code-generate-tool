...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePatientDoctorCopy.mc?method=editCoteriePatientDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId,faceUrl=',
				del:'CoteriePatientDoctorCopy.mc?method=deleteCoteriePatientDoctorCopy&PK=',
				view:'CoteriePatientDoctorCopy.mc?method=detailCoteriePatientDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId,faceUrl='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePatientDoctorCopy.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId,faceUrl'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  1 �����   2 �ɹ�   3 �ܾ� -->   
								<th align="center" rowName="coterieStatus" orderName="coterie_status:DESC" title='1 �����   2 �ɹ�   3 �ܾ� '>1 �����   2 �ɹ�   3 �ܾ� </th>
								<!-- ������  ����ʱ��-->   
