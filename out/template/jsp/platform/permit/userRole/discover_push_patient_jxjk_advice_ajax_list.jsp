...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'DiscoverPushPatientJxjkAdvice.mc?method=editDiscoverPushPatientJxjkAdvice&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType=',
				del:'DiscoverPushPatientJxjkAdvice.mc?method=deleteDiscoverPushPatientJxjkAdvice&PK=',
				view:'DiscoverPushPatientJxjkAdvice.mc?method=detailDiscoverPushPatientJxjkAdvice&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType='
			};
			var options = {
				tableId:'pageTable',
				url:'DiscoverPushPatientJxjkAdvice.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
