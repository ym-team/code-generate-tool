...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoteriePatientDoctorCopy(PK) {
			jQuery.ajax({
				url : "CoteriePatientDoctorCopy.mc?method=deleteCoteriePatientDoctorCopy",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoteriePatientDoctorCopy.mc?method=getAllPageCoteriePatientDoctorCopy" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_patient_doctor_copy_edit.jsp'">���</button>
						</td>
						<td align="right">
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							CoteriePatientDoctorCopy view = new CoteriePatientDoctorCopy();
								for (int i = 0; i < list.size(); i++) {
									view = (CoteriePatientDoctorCopy) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoteriePatientDoctorCopy.mc?method=editCoteriePatientDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId,faceUrl=<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getCoterieId() +":"+  view.getFaceUrl() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoteriePatientDoctorCopy('<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getCoterieId() +":"+  view.getFaceUrl() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoteriePatientDoctorCopy.mc?method=detailCoteriePatientDoctorCopy&id,name,coterieDesc,picUrl,coterieServiceType,coterieStatus,createTime,optTime,remark,char1,coterieId,faceUrl=<%= view.getId() +":"+  view.getName() +":"+  view.getCoterieDesc() +":"+  view.getPicUrl() +":"+  view.getCoterieServiceType() +":"+  view.getCoterieStatus() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() +":"+  view.getCoterieId() +":"+  view.getFaceUrl() %>" title="����"></a> 
