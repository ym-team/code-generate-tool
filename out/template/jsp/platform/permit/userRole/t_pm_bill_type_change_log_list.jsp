					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- 主键列{璐﹀崟绫诲瀷琛ㄤ富閿?}-->   
								<th align="center" rowName="type_id" orderName="type_id:DESC" title='璐﹀崟绫诲瀷琛ㄤ富閿?'>璐﹀崟绫诲瀷琛ㄤ富閿?</th>
								<!-- 主键列{鎿嶄綔鏃堕棿}-->   
								<th align="center" rowName="opt_time" orderName="opt_time:DESC" title='鎿嶄綔鏃堕棿'>鎿嶄綔鏃堕棿</th>
								<!-- 主键列{鎿嶄綔浜嬮」 濡傚彉鏇翠竴绾х被鐩? 浜岀骇绫荤洰 鍙敤鐘舵??}-->   
								<th align="center" rowName="opt_event" orderName="opt_event:DESC" title='鎿嶄綔浜嬮」 濡傚彉鏇翠竴绾х被鐩? 浜岀骇绫荤洰 鍙敤鐘舵??'>鎿嶄綔浜嬮」 濡傚彉鏇翠竴绾х被鐩? 浜岀骇绫荤洰 鍙敤鐘舵??</th>
								<!-- 主键列{1:鏃犳晥 2鏈夋晥 榛樿2}-->   
						...
						%>
											...
											<td>
												...
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteTPmBillTypeChangeLog('<%= view.getPkId() +":"+  view.getTypeId() +":"+  view.getOptTime() +":"+  view.getOptEvent() +":"+  view.getStatus() +":"+  view.getOptUserId() +":"+  view.getDbUpdateTime() +":"+  view.getDbCreateTime() +":"+  view.getRemark() %>')" title="删除"></a>
