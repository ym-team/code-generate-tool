...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'DiscoverPushCash.mc?method=editDiscoverPushCash&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType=',
				del:'DiscoverPushCash.mc?method=deleteDiscoverPushCash&PK=',
				view:'DiscoverPushCash.mc?method=detailDiscoverPushCash&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType='
			};
			var options = {
				tableId:'pageTable',
				url:'DiscoverPushCash.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
