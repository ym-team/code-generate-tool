...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteDiscoverPushOfficeOrderComment(PK) {
			jQuery.ajax({
				url : "DiscoverPushOfficeOrderComment.mc?method=deleteDiscoverPushOfficeOrderComment",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/DiscoverPushOfficeOrderComment.mc?method=getAllPageDiscoverPushOfficeOrderComment" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							DiscoverPushOfficeOrderComment view = new DiscoverPushOfficeOrderComment();
								for (int i = 0; i < list.size(); i++) {
									view = (DiscoverPushOfficeOrderComment) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
