...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'OfficeSchedual.mc?method=editOfficeSchedual&officeSchedualId,officeServiceAttrId,officeServiceId,officeId=',
				del:'OfficeSchedual.mc?method=deleteOfficeSchedual&PK=',
				view:'OfficeSchedual.mc?method=detailOfficeSchedual&officeSchedualId,officeServiceAttrId,officeServiceId,officeId='
			};
			var options = {
				tableId:'pageTable',
				url:'OfficeSchedual.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'officeSchedualId,officeServiceAttrId,officeServiceId,officeId'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
	                            ...
	                            <!--��ͷѭ����ʼ -->
								<!-- ������  排班id-->   
								<th align="center" rowName="officeSchedualId" orderName="office_schedual_id:DESC" title='排班id'>排班id</th>
								<!-- ������  服务类别id-->   
								<th align="center" rowName="officeServiceAttrId" orderName="office_service_attr_id:DESC" title='服务类别id'>服务类别id</th>
								<!-- ������  服务id-->   
								<th align="center" rowName="officeServiceId" orderName="office_service_id:DESC" title='服务id'>服务id</th>
								<!-- ������  工作室id-->   
