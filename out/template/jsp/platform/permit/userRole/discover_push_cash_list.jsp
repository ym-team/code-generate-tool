...
<%@ page import="server1.DiscoverPushCash" %>
...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteDiscoverPushCash(PK) {
			jQuery.ajax({
				url : "DiscoverPushCash.mc?method=deleteDiscoverPushCash",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/DiscoverPushCash.mc?method=getAllPageDiscoverPushCash" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/discover_push_cash_edit.jsp'">���</button>
						</td>
						<td align="right">
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							DiscoverPushCash view = new DiscoverPushCash();
								for (int i = 0; i < list.size(); i++) {
									view = (DiscoverPushCash) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
