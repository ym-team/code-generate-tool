...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoteriePostComment(PK) {
			jQuery.ajax({
				url : "CoteriePostComment.mc?method=deleteCoteriePostComment",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoteriePostComment.mc?method=getAllPageCoteriePostComment" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_post_comment_edit.jsp'">���</button>
						</td>
						<td align="right">
						    	...
						    	<input type='text' class="input-small" name="comment_desc" placeholder="���ӻظ�����" value="${ param.comment_desc }"/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������{���ӻظ�����}-->   
								<th align="center" rowName="comment_desc" orderName="comment_desc:DESC" title='���ӻظ�����'>���ӻظ�����</th>
						...
						<%
							...
							CoteriePostComment view = new CoteriePostComment();
								for (int i = 0; i < list.size(); i++) {
									view = (CoteriePostComment) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoteriePostComment.mc?method=editCoteriePostComment&id,commentDesc,commentType,commentStatus,memberId,postId,coterieId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getCommentDesc() +":"+  view.getCommentType() +":"+  view.getCommentStatus() +":"+  view.getMemberId() +":"+  view.getPostId() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoteriePostComment('<%= view.getId() +":"+  view.getCommentDesc() +":"+  view.getCommentType() +":"+  view.getCommentStatus() +":"+  view.getMemberId() +":"+  view.getPostId() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoteriePostComment.mc?method=detailCoteriePostComment&id,commentDesc,commentType,commentStatus,memberId,postId,coterieId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getCommentDesc() +":"+  view.getCommentType() +":"+  view.getCommentStatus() +":"+  view.getMemberId() +":"+  view.getPostId() +":"+  view.getCoterieId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
