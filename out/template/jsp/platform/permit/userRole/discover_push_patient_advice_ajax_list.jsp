...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'DiscoverPushPatientAdvice.mc?method=editDiscoverPushPatientAdvice&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType=',
				del:'DiscoverPushPatientAdvice.mc?method=deleteDiscoverPushPatientAdvice&PK=',
				view:'DiscoverPushPatientAdvice.mc?method=detailDiscoverPushPatientAdvice&discoverPushOfficeId,pushUserId,pushUserInfo,fromUserId,fromUserInfo,toUserId,toUserInfo,innerPushType,innerPushSubType,pushServiceTitle,pushServiceMsg,pushServiceId,pushServiceMsgStatus,createTime,optTime,remark,pushStatus,pushServiceMoney,pushServiceCount,pushServiceType='
			};
			var options = {
				tableId:'pageTable',
				url:'DiscoverPushPatientAdvice.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ������-->   
								<th align="center" rowName="innerPushType" orderName="inner_push_type:DESC" title='������'>������</th>
								<!-- ������  ������-->   
								<th align="center" rowName="innerPushSubType" orderName="inner_push_sub_type:DESC" title='������'>������</th>
								<!-- ������  ���ͱ���-->   
								...
								<!-- ������  �¼�״̬-->   
								<th align="center" rowName="pushServiceMsgStatus" orderName="push_service_msg_status:DESC" title='�¼�״̬'>�¼�״̬</th>
								<!-- ������  ����ʱ��-->   
