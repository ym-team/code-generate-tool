...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'TPmExceptionBillToIngoreLog.mc?method=editTPmExceptionBillToIngoreLog&pkId,joinId,billCode,optTime,ingoreReason,status,optUserId,dbUpdateTime,dbCreateTime,remark=',
				del:'TPmExceptionBillToIngoreLog.mc?method=deleteTPmExceptionBillToIngoreLog&PK=',
				view:'TPmExceptionBillToIngoreLog.mc?method=detailTPmExceptionBillToIngoreLog&pkId,joinId,billCode,optTime,ingoreReason,status,optUserId,dbUpdateTime,dbCreateTime,remark='
			};
			var options = {
				tableId:'pageTable',
				url:'TPmExceptionBillToIngoreLog.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'pkId,joinId,billCode,optTime,ingoreReason,status,optUserId,dbUpdateTime,dbCreateTime,remark'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- 主键列  寮傚父璐﹀崟琛ㄤ富閿?-->   
								<th align="center" rowName="joinId" orderName="join_id:DESC" title='寮傚父璐﹀崟琛ㄤ富閿?'>寮傚父璐﹀崟琛ㄤ富閿?</th>
								<!-- 主键列  璐﹀崟缂栧彿-->   
								<th align="center" rowName="billCode" orderName="bill_code:DESC" title='璐﹀崟缂栧彿'>璐﹀崟缂栧彿</th>
								<!-- 主键列  鎿嶄綔鏃堕棿-->   
								<th align="center" rowName="optTime" orderName="opt_time:DESC" title='鎿嶄綔鏃堕棿'>鎿嶄綔鏃堕棿</th>
								<!-- 主键列  蹇界暐鍘熷洜-->   
								<th align="center" rowName="ingoreReason" orderName="ingore_reason:DESC" title='蹇界暐鍘熷洜'>蹇界暐鍘熷洜</th>
								<!-- 主键列  1:鏃犳晥 2鏈夋晥 榛樿2-->   
