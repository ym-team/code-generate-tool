...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoterieDoctorPost(PK) {
			jQuery.ajax({
				url : "CoterieDoctorPost.mc?method=deleteCoterieDoctorPost",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoterieDoctorPost.mc?method=getAllPageCoterieDoctorPost" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/coterie_doctor_post_edit.jsp'">���</button>
						</td>
						<td align="right">
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							CoterieDoctorPost view = new CoterieDoctorPost();
								for (int i = 0; i < list.size(); i++) {
									view = (CoterieDoctorPost) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoterieDoctorPost.mc?method=editCoterieDoctorPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,postUserId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getPostChannelType() +":"+  view.getCoterieId() +":"+  view.getPostCommentCount() +":"+  view.getPostUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoterieDoctorPost('<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getPostChannelType() +":"+  view.getCoterieId() +":"+  view.getPostCommentCount() +":"+  view.getPostUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoterieDoctorPost.mc?method=detailCoterieDoctorPost&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,postChannelType,coterieId,postCommentCount,postUserId,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getPostChannelType() +":"+  view.getCoterieId() +":"+  view.getPostCommentCount() +":"+  view.getPostUserId() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
