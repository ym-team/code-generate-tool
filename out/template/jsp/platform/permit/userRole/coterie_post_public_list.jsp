...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteCoteriePostPublic(PK) {
			jQuery.ajax({
				url : "CoteriePostPublic.mc?method=deleteCoteriePostPublic",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/CoteriePostPublic.mc?method=getAllPageCoteriePostPublic" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������{Ȧ��id Ĭ��Ϊ0}-->   
								<th align="center" rowName="coterie_id" orderName="coterie_id:DESC" title='Ȧ��id Ĭ��Ϊ0'>Ȧ��id Ĭ��Ϊ0</th>
								<!-- ������{1 ȫƽ̨ͨ�� 2 ľ��ҽ���� 3 ľ�޽������� 4.��У����app ���� 5.��Уh5 ���� 6Ȧ���� }-->   
								<th align="center" rowName="post_channel_type" orderName="post_channel_type:DESC" title='1 ȫƽ̨ͨ�� 2 ľ��ҽ���� 3 ľ�޽������� 4.��У����app ���� 5.��Уh5 ���� 6Ȧ���� '>1 ȫƽ̨ͨ�� 2 ľ��ҽ���� 3 ľ�޽������� 4.��У����app ���� 5.��Уh5 ���� 6Ȧ���� </th>
								<!-- ������{������}-->   
						...
						<%
							...
							CoteriePostPublic view = new CoteriePostPublic();
								for (int i = 0; i < list.size(); i++) {
									view = (CoteriePostPublic) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="CoteriePostPublic.mc?method=editCoteriePostPublic&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,coterieId,postChannelType,postUserId,postCommentCount,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getCoterieId() +":"+  view.getPostChannelType() +":"+  view.getPostUserId() +":"+  view.getPostCommentCount() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteCoteriePostPublic('<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getCoterieId() +":"+  view.getPostChannelType() +":"+  view.getPostUserId() +":"+  view.getPostCommentCount() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>')" title="ɾ��"></a>
											    <a class="o-view" href="CoteriePostPublic.mc?method=detailCoteriePostPublic&id,title,postDesc,picUrl,vedioUrl,postType,postStatus,coterieId,postChannelType,postUserId,postCommentCount,createTime,optTime,remark,char1=<%= view.getId() +":"+  view.getTitle() +":"+  view.getPostDesc() +":"+  view.getPicUrl() +":"+  view.getVedioUrl() +":"+  view.getPostType() +":"+  view.getPostStatus() +":"+  view.getCoterieId() +":"+  view.getPostChannelType() +":"+  view.getPostUserId() +":"+  view.getPostCommentCount() +":"+  view.getCreateTime() +":"+  view.getOptTime() +":"+  view.getRemark() +":"+  view.getChar1() %>" title="����"></a> 
