...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePatient.mc?method=editCoteriePatient&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,channelType,memberCount,postCount,subSystemType,systemType,createTime,optTime,remark,char1,faceUrl=',
				del:'CoteriePatient.mc?method=deleteCoteriePatient&PK=',
				view:'CoteriePatient.mc?method=detailCoteriePatient&id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,channelType,memberCount,postCount,subSystemType,systemType,createTime,optTime,remark,char1,faceUrl='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePatient.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,name,coterieDesc,picUrl,coterieType,coterieServiceType,coterieStatus,createUserId,channelType,memberCount,postCount,subSystemType,systemType,createTime,optTime,remark,char1,faceUrl'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  Ȧ�ӽ���-->   
								<th align="center" rowName="coterieDesc" orderName="coterie_desc:DESC" title='Ȧ�ӽ���'>Ȧ�ӽ���</th>
								<!-- ������  Ȧ��ͼ ���6��ͼ ��|�ָ�-->   
								<th align="center" rowName="picUrl" orderName="pic_url:DESC" title='Ȧ��ͼ ���6��ͼ ��|�ָ�'>Ȧ��ͼ ���6��ͼ ��|�ָ�</th>
								<!-- ������  1 ��Ȧ 2 ˽Ȧ-->   
								<th align="center" rowName="coterieType" orderName="coterie_type:DESC" title='1 ��Ȧ 2 ˽Ȧ'>1 ��Ȧ 2 ˽Ȧ</th>
								<!-- ������  Ȧ��ҵ������ ��δ���� Ĭ��Ϊ0-->   
								<th align="center" rowName="coterieServiceType" orderName="coterie_service_type:DESC" title='Ȧ��ҵ������ ��δ���� Ĭ��Ϊ0'>Ȧ��ҵ������ ��δ���� Ĭ��Ϊ0</th>
								<!-- ������  1 �����   2 �ɹ�   3 �ܾ�   4. ��ɢ-->   
								<th align="center" rowName="coterieStatus" orderName="coterie_status:DESC" title='1 �����   2 �ɹ�   3 �ܾ�   4. ��ɢ'>1 �����   2 �ɹ�   3 �ܾ�   4. ��ɢ</th>
								<!-- ������  ������id-->   
								...
								<!-- ������  ��Ա��-->   
								<th align="center" rowName="memberCount" orderName="member_count:DESC" title='��Ա��'>��Ա��</th>
								<!-- ������  ������-->   
								<th align="center" rowName="postCount" orderName="post_count:DESC" title='������'>������</th>
								<!-- ������  ϵͳȦ Ϊ deptId    �Խ�ȦΪ 0-->   
								<th align="center" rowName="subSystemType" orderName="sub_system_type:DESC" title='ϵͳȦ Ϊ deptId    �Խ�ȦΪ 0'>ϵͳȦ Ϊ deptId    �Խ�ȦΪ 0</th>
								<!-- ������  1 ϵͳĬ��Ȧ  2 �Խ�Ȧ-->   
								<th align="center" rowName="systemType" orderName="system_type:DESC" title='1 ϵͳĬ��Ȧ  2 �Խ�Ȧ'>1 ϵͳĬ��Ȧ  2 �Խ�Ȧ</th>
								<!-- ������  ����ʱ��-->   
