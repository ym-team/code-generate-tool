...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteSysVersionData(PK) {
			jQuery.ajax({
				url : "SysVersionData.mc?method=deleteSysVersionData",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/SysVersionData.mc?method=getAllPageSysVersionData" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							SysVersionData view = new SysVersionData();
								for (int i = 0; i < list.size(); i++) {
									view = (SysVersionData) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
						...
						%>
											...
											<td>
												<a class="o-edit" href="SysVersionData.mc?method=editSysVersionData&codeType,codeValue,codeName,codeDesc,codeTypeAlias,sortId,state,externCodeType=<%= view.getCodeType() +":"+  view.getCodeValue() +":"+  view.getCodeName() +":"+  view.getCodeDesc() +":"+  view.getCodeTypeAlias() +":"+  view.getSortId() +":"+  view.getState() +":"+  view.getExternCodeType() %>" title="�༭"></a> 
												<a class="cbtn o-trash" href="javascript:void(0)" onclick="deleteSysVersionData('<%= view.getCodeType() +":"+  view.getCodeValue() +":"+  view.getCodeName() +":"+  view.getCodeDesc() +":"+  view.getCodeTypeAlias() +":"+  view.getSortId() +":"+  view.getState() +":"+  view.getExternCodeType() %>')" title="ɾ��"></a>
											    <a class="o-view" href="SysVersionData.mc?method=detailSysVersionData&codeType,codeValue,codeName,codeDesc,codeTypeAlias,sortId,state,externCodeType=<%= view.getCodeType() +":"+  view.getCodeValue() +":"+  view.getCodeName() +":"+  view.getCodeDesc() +":"+  view.getCodeTypeAlias() +":"+  view.getSortId() +":"+  view.getState() +":"+  view.getExternCodeType() %>" title="����"></a> 
