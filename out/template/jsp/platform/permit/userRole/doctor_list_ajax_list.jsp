...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'DoctorList.mc?method=editDoctorList&rowno,docType,userSeqId,userName,userType,sex,birthdate,province,cityCode,companyId,companyName,deptId,deptName,educationLevel,entrySchoolDate,mediaType,professionalTitle,jobTitle,userLevel,userFaceUrl,opTime,remark,agreementState,goodAtSymptom,deptPhone,reserve1,reserve2,userBrifeDesc,adviceNum=',
				del:'DoctorList.mc?method=deleteDoctorList&PK=',
				view:'DoctorList.mc?method=detailDoctorList&rowno,docType,userSeqId,userName,userType,sex,birthdate,province,cityCode,companyId,companyName,deptId,deptName,educationLevel,entrySchoolDate,mediaType,professionalTitle,jobTitle,userLevel,userFaceUrl,opTime,remark,agreementState,goodAtSymptom,deptPhone,reserve1,reserve2,userBrifeDesc,adviceNum='
			};
			var options = {
				tableId:'pageTable',
				url:'DoctorList.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'rowno,docType,userSeqId,userName,userType,sex,birthdate,province,cityCode,companyId,companyName,deptId,deptName,educationLevel,entrySchoolDate,mediaType,professionalTitle,jobTitle,userLevel,userFaceUrl,opTime,remark,agreementState,goodAtSymptom,deptPhone,reserve1,reserve2,userBrifeDesc,adviceNum'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)-->   
								<th align="center" rowName="docType" orderName="doc_type:DESC" title='ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)'>ҽ������ xl(����),yy(Ӫ��),zj(ר��),pl(��ͨ)</th>
								<!-- ������  �û�ID-->   
								...
								<!-- ������  �Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��-->   
								<th align="center" rowName="agreementState" orderName="agreement_state:DESC" title='�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��'>�Ķ�Э��״̬0:δ�Ķ�ͬ��;1:���Ķ���ͬ��</th>
								<!-- ������  �ó���״-->   
								<th align="center" rowName="goodAtSymptom" orderName="good_at_symptom:DESC" title='�ó���״'>�ó���״</th>
								<!-- ������  ���ҵ绰-->   
								<th align="center" rowName="deptPhone" orderName="dept_phone:DESC" title='���ҵ绰'>���ҵ绰</th>
								<!-- ������  �����ֶ�1-->   
								...
								<!-- ������  ��ѯ������-->   
								<th align="center" rowName="adviceNum" orderName="advice_num:DESC" title='��ѯ������'>��ѯ������</th>
								<!--��ͷѭ������ -->	
	                    		<th align="center">�� ��</th>                    
							</tr>
						</thead>
