...
<script type="text/javascript" src="${contextPath}/skins/js/common/scroll_common_js.js"></script>
	...
	<script type="text/javascript">
		function deleteDiscoverPushCmccAdvice(PK) {
			jQuery.ajax({
				url : "DiscoverPushCmccAdvice.mc?method=deleteDiscoverPushCmccAdvice",
				type : "post",
				data : {PK:PK},
...
<body>
	<form name="searchForm" method="post" class="form-search" action="${contextPath}/DiscoverPushCmccAdvice.mc?method=getAllPageDiscoverPushCmccAdvice" id="searchForm">
 		<!-- ��ѯ������ʾ����start -->
 		<div style="height: 50px;">
					<table id="tblSearch" width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr class="theight">
						<td>
							<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<%=contextPath%>/jsp/platform/permit/userRole/discover_push_cmcc_advice_edit.jsp'">���</button>
						</td>
						<td align="right">
				...
				<div class="tabelist">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-hover table-condensed">
						...
						<%
							...
							DiscoverPushCmccAdvice view = new DiscoverPushCmccAdvice();
								for (int i = 0; i < list.size(); i++) {
									view = (DiscoverPushCmccAdvice) list.get(i);
									if (i % 2 == 1) {
						%>
										<tr class="blue">
						<%
