...
<body class="bgcolor3">
	<%
		CmUserBaseInfoView vo = (CmUserBaseInfoView) request.getAttribute("CmUserBaseInfo");
		if (vo == null) {
			vo = new CmUserBaseInfoView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="CmUserBaseInfo.mc?method=updateCmUserBaseInfoJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='CmUserBaseInfo.mc?method=getAllPageCmUserBaseInfo&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
