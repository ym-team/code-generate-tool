...
<head>
   ...
   <script type="text/javascript">
		...
		$(function(){
			...
			var operates = {
				edit:'CoteriePostComment.mc?method=editCoteriePostComment&id,commentDesc,commentType,commentStatus,memberId,postId,coterieId,createTime,optTime,remark,char1=',
				del:'CoteriePostComment.mc?method=deleteCoteriePostComment&PK=',
				view:'CoteriePostComment.mc?method=detailCoteriePostComment&id,commentDesc,commentType,commentStatus,memberId,postId,coterieId,createTime,optTime,remark,char1='
			};
			var options = {
				tableId:'pageTable',
				url:'CoteriePostComment.mc?method=ajax',
				operates:operates,
				formId:'searchForm',
				searchId:'searchBtn',
				primaryKey:'id,commentDesc,commentType,commentStatus,memberId,postId,coterieId,createTime,optTime,remark,char1'
			};
					...
					<table id="pageTable" width="100%" border="0" class="table table-hover table-condensed" cellpadding="0" cellspacing="0">
	  					<thead>
	                    	<tr height="22" class="tab_title_bg">
								...
								<!-- ������  ���ӻظ�����-->   
								<th align="center" rowName="commentDesc" orderName="comment_desc:DESC" title='���ӻظ�����'>���ӻظ�����</th>
