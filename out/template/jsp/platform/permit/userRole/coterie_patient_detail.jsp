...
<body class="bgcolor3">
	<%
		CoteriePatientView vo = (CoteriePatientView) request.getAttribute("CoteriePatient");
		if (vo == null) {
			vo = new CoteriePatientView();
		}
	%>
	<div class="breadcrumb">
		...
		<form id="form1" name="form1" method="post" action="CoteriePatient.mc?method=updateCoteriePatientJsp" border="0">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table table-bordered table-striped" align="center">
				...
				<tr>
					<td >&nbsp;</td>
					<td height="60">
						<input type="button" class="btn-return" onclick="javascript:window.location.href='CoteriePatient.mc?method=getAllPageCoteriePatient&start=0&pageSize=10'" value="����" />
					</td>
				</tr>
			</table>
		</form>
